...
#### 5. Run Alfworld Evaluation (Embodied AI)

Flash-Searcher also supports Alfworld household simulation tasks:
...
See [docs/alfworld_guide.md](docs/alfworld_guide.md) for detailed instructions.
