#!/bin/bash
# ============================================================================
# Run GAIA tasks with Qwen2.5-7B-Instruct model on GPU 0 and 1
# 
...
echo "=========================================="
echo "GAIA Evaluation with Qwen2.5-7B-Instruct"
...
echo "=========================================="
echo "Command:"
echo "  python run_flash_searcher_mm_gaia.py ${CMD_ARGS[*]}"
echo ""
echo "Evaluation logs: ${LOG_DIR}/gaia_eval.log"
echo "=========================================="
echo ""
...
# Run evaluation
python run_flash_searcher_mm_gaia.py "${CMD_ARGS[@]}" 2>&1 | tee ${LOG_DIR}/gaia_eval.log
...
if [ ${EVAL_EXIT_CODE} -eq 0 ]; then
    ...
    echo "  - Evaluation log: ${LOG_DIR}/gaia_eval.log"
else
